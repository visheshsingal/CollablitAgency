...
export function OverviewView({ client, booking }) {
  const completedStepsCount = (client.processSteps || []).filter(
    (s) => s.status === 'complete'
  ).length

  return (
    <div className="client-canvas-wrapper">
...
export function ProcessView({ client }) {
  return (
    <div className="client-canvas-wrapper">
...
export function DocumentsView({ client }) {
  return (
    <div className="client-canvas-wrapper">
      <section className="panel">
        <div className="panel-header">
...
export function MeetingsView({ booking }) {
  return (
    <div className="client-canvas-wrapper page-stack">
      <section className="panel">
        <div className="panel-header">
          <div>
...
export const workspaceStyles = `
  ...
  .progress-footer strong { color: #fff; }
  ...
  .documents-grid { display: grid; gap: 10px; }
  ...
  .doc-type-icon { color: #d39b45; flex-shrink: 0; }
  ...
  .open-arrow { color: #94a3b8; flex-shrink: 0; }
  .doc-card:hover .open-arrow { color: #ad702c; }
  ...
  .empty-state-box strong { color: #0f172a; font-size: 0.95rem; }
  ...
  .meeting-content { display: flex; flex-direction: column; gap: 16px; }
  ...
  .join-meet-btn:hover { background: #16345f; }
  ...
  .contact-card-body { display: flex; flex-direction: column; gap: 14px; }
  ...
  .contact-person strong { display: block; font-size: 0.92rem; color: #0f172a; }
  .contact-person small { display: block; font-size: 0.74rem; color: #64748b; }
